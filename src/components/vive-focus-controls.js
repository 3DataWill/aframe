...
var VIVE_FOCUS_CONTROLLER_MODEL_URL = 'https://cdn.aframe.io/controllers/oculus/go/oculus-go-controller.gltf';
...
module.exports.Component = registerComponent('vive-focus-controls', {
  ...
  // No need for onButtonChanged, since Vive Focus controller has no analog buttons.
